...
\textbf{Feature}                                                    & \textbf{Origem no Diagnóstico} & \textbf{Estória}                                           & \textbf{Origem no Diagnóstico} \\ \hline
\endhead
F01 - Escolher Técnica de elicitação de requisitos & \multirow{2}{*}{Não} & H01 - Indicar técnica
...
F02 - Elicitar Requisitos Junto Ao Cliente         & \multirow{4}{*}{Não} & H01 - Estruturação dos requisitos (rastreabilidade) (Médio)                       & Não                  \\ \cline{3-4}
                                                                    ...
                                                                    &                      & H04 - Elicitar Requisitos Junto Ao Cliente (Fácil)                 & Não                  \\ \cline{3-4}
...
F09 Projeto Kanban (Gerência de projetos) & \multirow{2}{*}{Não} & F09/H01 - Cadastrar projeto & Não \\ \cline{3-4}
...
\\ \cline{2-4} 
 & \multirow{9}{3.0cm}{F01 - Escolher Técnica de elicitação de requisitos} & F01/H03 - Cadastrar técnicas de elicitação &  \multirow{2}{5.2cm}{F03/H02 - Guia de padrão de nomenclatura de objetos de dados (Fácil, Fagner)}
\\ \cline{3-3}
...
\\ \cline{2-4} 
 & F02 - Elicitar requisitos junto ao cliente & F02/03 - Guia de prototipagem rápido (Fácil, Fagner) &  \multirow{2}{5.2cm}{F02/03 - Guia de prototipagem rápido (Fácil, Fagner)}
\\ \cline{2-3}
...
A figura 16 representa o cadastro de informações de um projeto, uma das mais importantes do sistema pois permite ao desenvolvedor cadastrar e editar informações a cerca do projeto no qual está trabalhando. \clearpage
