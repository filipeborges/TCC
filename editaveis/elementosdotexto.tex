...
Para se atingir o objetivo deste trabalho, realizou-se, inicialmente, uma entrevista com o propósito de diagnosticar a situação do desenvolvimento descentralizado no Órgão X, através da coleta dos problemas, das boas práticas e das sugestões de melhoria, relatados pelos próprios desenvolvedores. A partir do diagnóstico, foram definidas as atividades e as boas práticas da solução de apoio, e em seguida um relacionamento destas atividades foi feito, através da elaboração de um fluxograma.
