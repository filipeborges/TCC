...
A entrevista foi aplicada com 8 desenvolvedores diferentes, 7 estagiários e 1 servidor, que participam do desenvolvimento descentralizado no Órgão X. A escolha dos participantes foi feita de forma aleatória. A categoria "Descrição do Desenvolvedor" serviu exclusivamente para contextualizar os entrevistados, portanto as respostas desta categoria foram desconsideradas na análise das entrevistas. A tabela 2 contextualiza o perfil dos desenvolvedores entrevistados. Observa-se que alguns desses dados não se aplicam ao desenvolvedor 6, por este ser um servidor.\clearpage
