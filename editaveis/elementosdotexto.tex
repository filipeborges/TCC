...
\begin{itemize}
	...
	\item \textbf{Pesquisa participante}: É uma modalidade de pesquisa que tem como propósito “auxiliar a população envolvida a identificar por si mesma os seus problemas, a realizar a análise crítica destes e a buscar as soluções adequadas” (LE BOTERF, 1984, p. 52).
	\item \textbf{Pesquisa-ação participante}: É uma pesquisa comprometida com o modelo de ação "aplicação edificante" do conhecimento científico (SANTOS, 1989, p. 159), que tem, entre outros, os princípios: ter um lugar em situações concretas em quem aplica está ética, existencial e socialmente comprometido; é um processo argumentativo entre grupos que lutam pela decisão do conflito a seu favor; envolve o cientista na luta pelo equilíbrio do poder, obrigando-o assim a tomar o partido daqueles que têm menos poder; aceita que os limites e deficiências dos saberes locais não justificam a recusa desses, porque isso significa desarmar argumentativa e socialmente seres competentes. Assim a pesquisa-ação participante pode ser considerada como o produto da influência da pesquisa participante sobre a pesquisa-ação.
