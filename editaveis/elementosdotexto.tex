...
\section{Metodologia de Construção da Solução}

A metodologia usada para a construção da solução foi a metodologia ágil, mais especificamente o método \textit{Scrum}. Decidiu-se pelo \textit{Scrum} devido a sua flexibilidade e por consequência o seu menor encargo sobre a construção da solução. Duas etapas foram realizadas para o planejamento da construção:
...
Uma vez concluídas essas etapas, o início da construção da solução se inicia com a definição da primeira \textit{Sprint}. Ao início de cada \textit{Sprint} um conjunto de estórias foram priorizadas para serem concluídas até o final da mesma.
...
\section{Construção da Solução de Apoio}

A construção da solução de apoio foi planejada levando-se em conta duas etapas que foram previamente executadas ao início da construção:
...
Em relação ao período de cada \textit{Sprint}, definiu-se que a primeira \textit{Sprint} seria maior do que as outras por conta de ajustar a medida de produtividade, e as \textit{Sprints} seguintes seriam fixadas em períodos de 1 semana.

\subsection{Execução das Sprints}

Uma vez que as \textit{Features}/Estórias foram elaboradas e o período padrão de cada \textit{Sprint} definido, deu-se início a execução das \textit{Sprints}. Cada estória planejada na \textit{Sprint} está associada com a sua dificuldade e com o respectivo membro responsável pela sua conclusão.

As tabelas 11, 12, 13 e 14 ilustram respectivamente o planejamento das \textit{Sprints} 1, 2, 3 e 4.
...
A \textit{Sprint 1} teve duração de 1 semana e 4 dias, pois se tratava de uma \textit{Sprint} de ajuste da produtividade. Foi concluída somente uma única estória de dificuldade média, e a estória F02/H03 não possuiu nenhum membro responsável associado pois estava em aberto para o membro que conseguisse finalizar as suas estórias primeiro.
...
Na \textit{Sprint} 2 as \textit{Features} 01 e 02 foram retiradas para a inclusão das \textit{Features} 03 e 05, consideradas de maior prioridade. Portanto as estórias F01/H01, F01/H02 e F02/H03 foram excluídas em favor da inclusão das estórias F03/H02, F03/H05, F05/H03 e F05/H04. A estória F03/H03 veio da \textit{Sprint} anterior.
...
A \textit{Sprint} 3 contemplou estórias da \textit{Sprint} anterior (F03/H02, F03/H05), além da inclusão da \textit{Feature} 04 com a estória F04/H01, considerada uma das mais importantes da solução, e da inclusão da estória F05/H05, relacionada com o conjunto de estórias F05/H03 e F05/H04 da \textit{Sprint} passada. 
...
Para a \textit{Sprint} 4 foram incluídas de volta as duas estórias da \textit{Feature} 01 não concluídas na \textit{Sprint} 1, F01/H01 e F01/H02, além da inclusão de uma estória da \textit{Feature} 07 (F01/H01), de forma a contemplar outras etapas do ciclo de vida da solução. As estórias F03/H02, F03/H05 e F04/H01 vieram da \textit{Sprint} passada. 
