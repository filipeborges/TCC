...
Montar uma espécie WIKI complementar, dentro da aplicação, de forma que as informações da solução possam ser consultadas de forma mais conveniente. & Funcionalidade: Consulta de informações da solução, semelhante a uma \textit{Wiki} & Solução Proposta &   \multirow{6}{*}{Implementação}                                                               \\ \cline{1-3}
...
Ao todo, 16 atividades e X guias compõem a solução.
