...
\begin{figure}[h]
	...
	\caption{Relação escopo de aplicação e esforço de aprendizagem}
\end{figure}

Características importantes que motivam os usuários finais em um desenvolvimento de software são o empoderamento, a velocidade de desenvolvimento, a flexibilidade e o controle local \cite{fischer2004}. Um dos benefícios obtidos com o EUD é que as potenciais falhas de precisão geradas pela comunicação de informações são eliminadas, já que o usuário final, que possui conhecimento do domínio, é quem irá desenvolver o software \cite{fischer2004}.
