...
\section{\textit{Metodologia} (REFATORAR: PESQUISA PARTICIPANTE)}
...
As estórias elaboradas seguem a hierarquia \textit{Feature}/Estória, de forma que algumas funcionalidades e atividades viraram uma \textit{Feature} devido à sua abrangência de conteúdo. Além disso, certos guias e atividades relacionados foram agrupados em \textit{Features} criadas, e algumas estórias foram quebradas de forma a diminuir sua granularidade. Por fim cada estória recebeu uma classificação em relação a sua dificuldade (Fácil, Médio, Difícil) de forma a ajudar no planejamento da \textit{Sprint}. A tabela 4 ilustra o conjunto de \textit{Features}/Estórias elaborado.

\begin{longtable}{|M{6.0cm}|M{3.0cm}|M{3.0cm}|M{2.7cm}|}
\caption{\textit{Features}/Estórias elaboradas}\\\hline
\textbf{Feature}                                                    & \textbf{Foi criado?} & \textbf{Estória}                                           & \textbf{Foi criado?} \\ \hline
\endfirsthead
\hline
\textbf{Feature}                                                    & \textbf{Foi criado?} & \textbf{Estória}                                           & \textbf{Foi criado?} \\ \hline
\endhead
