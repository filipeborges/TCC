...
A \textit{Sprint 1} teve duração de 1 semana e 2 dias, pois se tratava de uma \textit{Sprint} de ajuste. Foi concluída somente uma única estória de dificuldade média, e a estória F02/H03 não possuiu nenhum membro responsável pois estava como um adicional caso algum membro finalizasse suas estórias muito rapidamente. \pagebreak
...
Na \textit{Sprint} 3 houve a inclusão da \textit{Feature} 04 com a estória F04/H01, considerada uma das mais importantes da solução, e a inclusão da estória F05/H05, relacionada com o conjunto de estórias F05/H03 e F05/H04 concluídas na \textit{Sprint} passada. \pagebreak
...
Na \textit{Sprint} 5 mantiveram-se o conjunto de estórias não concluídas na \textit{Sprint} passada. \pagebreak
...
Na \textit{Sprint} 7 se manteve o mesmo conjunto de estórias da \textit{Sprint} passada. \pagebreak
...
Para a \textit{Sprint} 9 foram incluídas as \textit{Features} 3 e 7 com as estórias F03/H05 e F07/H02 respectivamente. \pagebreak
