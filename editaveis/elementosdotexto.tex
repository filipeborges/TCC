...
As atividades, as tarefas, os guias e os modelos, definidos no processo, que se encaixam em uma possível solução aos problemas, sugestões e boas práticas relatados no diagnóstico, foram utilizados na construção da solução de apoio.
