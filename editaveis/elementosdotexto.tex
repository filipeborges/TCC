...
\section{Processo de Construção da Solução (PENDENTE)}
...
Uma vez que as \textit{Features} e estórias foram definidas o início da construção da solução se inicia com a definição da primeira \textit{Sprint}, que teve duração maior do que as outras por conta de ajuste da medida de produtividade. As \textit{Sprints} seguintes foram fixadas em períodos de 1 semana. Ao início de cada \textit{Sprint} um conjunto de estórias foram priorizadas para serem concluídas até o final da mesma, onde cada estória está associada com a sua dificuldade e com o respectivo membro responsável pela sua conclusão. A seguir são apresentadas as tabelas com as estórias planejadas e  concluídas em cada \textit{Sprint}.
...
A \textit{Sprint 1} teve duração de 1 semana e 4 dias, pois se tratava de uma \textit{Sprint} de ajuste da produtividade. Foi concluída somente uma única estória de dificuldade média, e a estória F02/H03 não possuiu nenhum membro responsável associado pois estava em aberto para o membro que conseguisse finalizar as suas estórias primeiro. \pagebreak
...
A \textit{Sprint} 3 contemplou estórias da \textit{Sprint} anterior (F03/H02, F03/H05), além da inclusão da \textit{Feature} 04 com a estória F04/H01, considerada uma das mais importantes da solução, e da inclusão da estória F05/H05, relacionada com o conjunto de estórias F05/H03 e F05/H04 da \textit{Sprint} passada. \pagebreak
...
\section{SISAEUD - Sistema de Apoio ao Desenvolvimento Descentralizado (PENDENTE)}

\textit{Descrever a solução, usando prints das telas mais representativas.}

\section{Problemas resolvidos com o SISAUED (PENDENTE)}

\textit{Fazer uma relação do que foi implementado com a solução proposta e quais os problemas estão resolvendo, com base no diagnóstico.}
