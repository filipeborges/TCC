...
\chapter[Capítulo 2 - EUD e Desenvolvimento descentralizado]{Capítulo 2 - EUD e Desenvolvimento descentralizado}
...
%\usepackage{multirow}
%\newcolumntype{M}[1]{>{\centering\arraybackslash}m{#1}}
\begin{table}{|M{1.3cm} | m{14.0cm}|} %[]
	\centering
	\caption{Chaves representando os diferentes significados das respostas das entrevistas}
	\label{my-label}
	\begin{tabular}{|l|l|l|}
		\hline
		\textbf{Categoria}                                    & \textbf{Chave} & \textbf{Descrição}                                                                                                                                                                                                                                               \\ \hline
		\multirow{4}{*}{Co1 - Papel do desenvolvedor}         & C1             & Papel claro dentro da instituição                                                                                                                                                                                                                                \\ \cline{2-3} 
		...
		\multirow{6}{*}{Co2 - Preparação}                     & C5             & Curso da somente uma introdução                                                                                                                                                                                                                                  \\ \cline{2-3} 
		...
		\multirow{3}{*}{Co3 - Elicitação de Requisitos}       & C11            & Os requisitos são levantados através de reuniões                                                                                                                                                                                                                 \\ \cline{2-3} 
		...
		\multirow{4}{*}{Co4 - Gerenciamento de Requisitos}    & C14            & Registro de requisitos em papel                                                                                                                                                                                                                                  \\ \cline{2-3} 
		...
		\multirow{6}{*}{Co5 - Modelagem do Sistema}           & C18            & Não atualiza o modelo de dados                                                                                                                                                                                                                                   \\ \cline{2-3} 
		...
		\multirow{4}{*}{Co6 - Depuração}                      & C24            & Realiza depurações no sistema com o APEX                                                                                                                                                                                                                         \\ \cline{2-3} 
		...
		\multirow{7}{*}{Co7 - Estilo e \textit{Design} de Codificação} & C28            & Falta do uso de um padrão de boas práticas comprometeu a qualidade da aplicação                                                                                                                                                                                  \\ \cline{2-3} 
		...
		\multirow{3}{*}{Co8 - Ambiente de Codificação}        & C35            & Reutilização de código                                                                                                                                                                                                                                           \\ \cline{2-3} 
		& C36            & Uso de editores externos                                                                                                                                                                                                                                         \\ \cline{2-3} 
		& C37            & Uso do editor do APEX                                                                                                                                                                                                                                            \\ \hline
		\multirow{6}{*}{Co9 - Teste}                          & C38            & Uso de testes funcionais                                                                                                                                                                                                                                         \\ \cline{2-3} 
		...
		\multirow{8}{*}{Co10 - Implantação}                   & C44            & Costuma verificar se os apelidos não estão duplicados                                                                                                                                                                                                            \\ \cline{2-3} 
