...
\textbf{Feature}                                                    & \textbf{Foi criado?} & \textbf{Estória}                                           & \textbf{Foi criado?} \\ \hline
\endhead
F01 - Escolher Técnica de elicitação de requisitos & \multirow{2}{*}{Não} & H01 - Indicar técnica de elicitação                        & Sim                  \\ \cline{3-4} 
                                                                    &                      & H02 - Visualizar guia de técnica de elicitação             & Sim                  \\ \hline
F02 - Elicitar Requisitos Junto Ao Cliente         & \multirow{4}{*}{Não} & H01 - Estruturar informações obtidas                       & Não                  \\ \cline{3-4}
                                                                    &                      & H02 - Priorizar funcionalidades a serem desenvolvidas      & Não                  \\ \cline{3-4} 
                                                                    &                      & H03 - Guia de prototipagem rápido                          & Não                  \\ \cline{3-4} 
                                                                    &                      & H04 - Elicitar Requisitos Junto Ao Cliente                 & Não                  \\ \hline
F03 - Construir modelo de dados                    & \multirow{7}{*}{Não} & H01 - Guia de criação e padrões de BD                      & Não                  \\ \cline{3-4} 
                                                                    &                      & H02 - Guia de padrão de nomenclatura de objetos de dados   & Não                  \\ \cline{3-4} 
                                                                    &                      & H03 - Guia de geração de scripts sql                       & Não                  \\ \cline{3-4} 
                                                                    &                      & H04 - Construir modelo de dados                            & Não                  \\ \cline{3-4} 
                                                                    &                      & H05 - Validar modelo de dados                              & Não                  \\ \cline{3-4} 
                                                                    &                      & H06 - Atualizar modelo de dados                            & Não                  \\ \cline{3-4} 
                                                                    &                      & H07 - Validação de modelo de dados por responsável técnico & Sim                  \\ \hline
F04 - Implementação da aplicação                   & \multirow{3}{*}{Sim} & H01 - Guia de padrões e boas práticas Apex                 & Não                  \\ \cline{3-4} 
                                                                    &                      & H02 - Ajustar interface                                    & Não                  \\ \cline{3-4} 
                                                                    &                      & H03 - Aplicar regras de negócio                            & Não                  \\ \hline
F05 - Elaboração de código                         & \multirow{5}{*}{Sim} & H01 - Guia de boas práticas plsql                          & Não                  \\ \cline{3-4} 
                                                                    &                      & H02 - Guia sobre editor de código sql e plsql              & Não                  \\ \cline{3-4} 
                                                                    &                      & H03 - Cadastro de código reutilizável                      & Não                  \\ \cline{3-4} 
                                                                    &                      & H04 - Listar código reutilizável                           & Sim                  \\ \cline{3-4} 
                                                                    &                      & H05 - Editar código reutilizável                           & Sim                  \\ \hline
F06 - Procedimentos de teste                       & \multirow{6}{*}{Sim} & H01 - Preparar embiente de testes                          & Não                  \\ \cline{3-4} 
                                                                    &                      & H02 - Definir procedimento de testes                       & Não                  \\ \cline{3-4} 
                                                                    &                      & H03 - Geração de casos de testes                           & Não                  \\ \cline{3-4} 
                                                                    &                      & H04 - Guia de ferramenta de automação de teste             & Não                  \\ \cline{3-4} 
                                                                    &                      & H05 - Guia de teste de comportamento de código             & Não                  \\ \cline{3-4} 
                                                                    &                      & H06 - Guia de teste de página apex                         & Não                  \\ \hline
F07 - Tratamento de erros                          & \multirow{2}{*}{Sim} & H01 - Guia de uso de depuração de páginas apex             & Não                  \\ \cline{3-4} 
                                                                    &                      & H02 - Cadastro de erros conhecidos                         & Não                  \\ \hline
\end{longtable}

Em relação ao período de cada \textit{Sprint}, definiu-se que a primeira \textit{Sprint} seria maior do que as outras por conta de ajustar a medida de produtividade, e as \textit{Sprints} seguintes seriam fixadas em períodos de 1 semana. A primeira \textit{Sprint} teve duração de 1 semana e 4 dias.
