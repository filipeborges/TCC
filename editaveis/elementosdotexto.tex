...
\\ \cline{2-4} 
 & \multirow{2}{3.0cm}{F01 - Escolher Técnica de elicitação de requisitos} & F01/H01 - Indicar técnica de elicitação (Médio, Fagner) & \multirow{5}{5.2cm}{F03/H01 - Guia de criação e padrões de BD (Médio, Filipe)} 
\\ \cline{3-3}
...
\\ \cline{2-4} 
 & F01 - Escolher Técnica de elicitação de requisitos & F01/H01 - Indicar técnica de elicitação (Médio, Fagner) &  \multirow{3}{5.2cm}{F03/H02 - Guia de padrão de nomenclatura de objetos de dados (Fácil, Fagner)}
\\ \cline{3-3}
 &  & F01/H02 - Visualizar guia de técnica de elicitação (Fácil, Fagner) & 
\\ \cline{2-3}
